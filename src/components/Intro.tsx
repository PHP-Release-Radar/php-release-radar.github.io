...
export default function Intro({ links }: LinkProps) {
  return (
    <div className="intro">
      ...
      <p>
        ...
        in COVID-19 times where in-person events like conferences or meetups
        were not a thing.
      </p>
      <p>
        The goal of this interview series is to shed some light on Open Source
        PHP projects and their creators &amp; maintainers.
      </p>
      <p>
